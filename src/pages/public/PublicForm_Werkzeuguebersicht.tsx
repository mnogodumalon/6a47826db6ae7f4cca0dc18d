...
const PROXY_BASE = '';
const APP_ID = '6a478262711e1dc1b4b5e141';
...
export default function PublicFormWerkzeuguebersicht() {
    ...
    <div className="min-h-screen bg-background flex items-center justify-center p-4">
      <div className="w-full max-w-lg">
        <div className="text-center mb-8">
          <h1 className="text-2xl font-bold text-foreground">Werkzeugübersicht — Formular</h1>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-5 bg-card rounded-xl border border-border p-6 shadow-md">
          ...
          <div className="space-y-2">
            ...
            <Input
              ...
              onChange={e => { const n = e.target.value ? Math.max(0, Number(e.target.value)) : undefined; setFields(f => ({ ...f, kaufpreis: n })); }}
            />
          </div>
          <div className="space-y-2">
